const MainPageButton = ({ onClick }) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className="border-brown-40 bg-brown-10 text-caption1 font-regular flex items-center rounded-lg border px-[12px] py-[8px]"
    >
      <span className="text-brown-40">질문하러 가기</span>
      <svg
        width="18"
        height="18"
        viewBox="0 0 19 18"
        fill="none"
        className="text-brown-40 ml-[4px]"
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
