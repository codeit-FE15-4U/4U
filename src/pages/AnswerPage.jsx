...
const AnswerPage = () => {
  ...
  return (
    <div className="relative w-full max-w-716">
      <button className="bg-brown-40 text-grayscale-10 shadow-2pt pc:top-10 tablet:top-0 tablet:w-100 tablet:h-35 tablet:text-[15px] absolute top-23 right-0 w-70 cursor-pointer rounded-full text-[10px]/25 font-extralight">
        삭제하기
      </button>
